class GitatlasCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/grahambrooks/gitatlas-cli/archive/refs/tags/v2026.9.1.tar.gz"
      sha256 "7eb390272d90db494aaa97838741db552107c75a0cdd7756eeac9a02a61ca486"
    end
    on_intel do
